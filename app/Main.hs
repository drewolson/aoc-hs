...
import Aoc.TwentyOne.Day14 qualified as TwentyOne.Day14
...
run2021 input = \case
  ...
  Args {day = 14, part = 1} -> print $ TwentyOne.Day14.part1 input
  Args {day = 14, part = 2} -> print $ TwentyOne.Day14.part2 input
